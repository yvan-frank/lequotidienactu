...
final class Router
{
    public function dispatch(string $method, string $uri): void
    {
        ...
        if ($method === 'POST' && $path === '/api/admin/media/watermark-all') { $adminMedia->watermarkAll(); return; }
        if ($method === 'POST' && $path === '/api/admin/documents') { $adminMedia->uploadDocument(); return; }
        ...
        if ($method === 'GET' && $path === '/simulateur-arrima') { $public->arrimaCalculator(); return; }
